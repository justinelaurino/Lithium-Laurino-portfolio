# Chinese Zodiac Section Exercise

## Requirements

Create a program that asks the user for their year of birth, validates that it is not earlier than 1900, and displays the correct Chinese zodiac sign.
